...
<form action="StudentUpdateExecute.action" method="get" class="insert">
	<div style="margin-top:10px; margin-bottom:10px;">
		<label>入学年度</label>
		<input class="boader_none" type="text" name="ent_year" value="${ ent_year }" readonly style="border:none; outline:none; width:100%; padding:10px; margin-top:10px; margin-bottom:10px;">
	</div>

	<div style="margin-top:10px; margin-bottom:10px;">
		<label>学生番号</label>
		<input class="boader_none" type="text" name="no" value="${ no }" readonly  style="border:none; outline:none; width:100%; padding:10px; margin-top:10px; margin-bottom:10px;">
	</div>
	...
	在学中<input type="checkbox" name="is_attend" <c:if test="${ is_attend }">checked</c:if>><br>
